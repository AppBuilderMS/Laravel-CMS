...
<header class="header text-white h-fullscreen pb-80" style="background-image: url({{asset('storage/' . $post->image)}});" data-overlay="9">
    <div class="container text-center">
        ...
        <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p><span class="opacity-70 mr-1">Published</span> <a class="text-white" href="#">{{$post->published_at}}</a></p>
            <p><img class="avatar avatar-sm" src="{{asset('/img/user.png')}}" alt="..."></p>
...
<main class="main-content">
    ...
    <div class="section" id="section-content">
        ...
        <div class="row">
            {!!$post->content!!}  {{--Using !! !! to ignore html tags--}}
        </div>

        {{-- Adding social buttons --}}
        <div class="addthis_inline_share_toolbox_z74p pt-5"></div> {{--https://www.addthis.com/ --}}
        ...
        <div class="row">
            ...
            <script>
                ...
                *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                ...
                s.src = 'https://saas-blog-9zfuciiq2m.disqus.com/embed.js';
